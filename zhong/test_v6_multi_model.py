...
用法:
  python zhong\test_v6_multi_model.py
...
MODEL_CONFIGS = [
    ...
    {
        'name': 'Ours+Enhanced',
        'path': r'C:\Users\Administrator\tmp\mdp_v4\models\weights_19',
        'type': 'ours_enhanced',  # Lite-Mono decoder + temporal consistency 训练 (mdp_v4, fp32)
    },
]
