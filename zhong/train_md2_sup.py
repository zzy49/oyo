"""Monodepth2 基线 + GT深度监督 训练启动脚本"""
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'huifu', 'monodepth2-master'))
...
if __name__ == '__main__':
    print("=" * 60)
    print("  Monodepth2 基线训练 (多源: EndoSLAM+SCARED+Real)")
